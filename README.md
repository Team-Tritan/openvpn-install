...
You can also check out [wireguard-install](https://github.com/team-tritan/wireguard-install), a simple installer for a simpler, safer, faster and more modern VPN protocol.
...
```bash
curl -O https://raw.githubusercontent.com/team-tritan/openvpn-install/master/openvpn-install.sh
